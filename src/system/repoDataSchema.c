...
void dat_status_to_struct(dat_status_t *status)
{
    ...
    DAT_CPY_SYSTEM_VAR(status, dat_drp_scd);
    ...
    DAT_CPY_SYSTEM_VAR(status, dat_drp_ack_scd);
...
void dat_print_status(dat_status_t *status)
{
    ...
    DAT_PRINT_SYSTEM_VAR(status, dat_drp_scd);
    ...
    DAT_PRINT_SYSTEM_VAR(status, dat_drp_ack_scd);
